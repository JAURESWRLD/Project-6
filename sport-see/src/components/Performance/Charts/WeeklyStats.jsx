...
export const WeeklyStats = ({ heartDateRange, weeklyStats }) => {
  return (
          ...
          <div className={styles.pieChart}>
            ...
            <div className={styles.data}>
              ...
              <div className={styles.dataContent}>
                <span className={styles.intetityColorCircle} style={{ backgroundColor: weeklyStats.weeklyGoalData[0].fill }} />
                <div className={styles.div}>
                  <div className={styles.restants}>{weeklyStats.completedSessions} réalisées</div>
                </div>
              </div>
              <div className={styles.dataContent2}>
                <span className={styles.intetityColorCircle} style={{ backgroundColor: weeklyStats.weeklyGoalData[1].fill }} />
                <div className={styles.div}>
